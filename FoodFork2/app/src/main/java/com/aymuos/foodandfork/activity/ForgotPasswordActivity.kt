                        ...
                        try{
                            ...
                            if (success){
                                ...
                                if(firstTry){
                                    ...
                                    Toast.makeText(this@ForgotPasswordActivity, "OTP has been sent to your registered email ID", Toast.LENGTH_SHORT).show()


                                }else{
                                    Toast.makeText(this@ForgotPasswordActivity, "Please check the OTP sent before", Toast.LENGTH_SHORT).show()
