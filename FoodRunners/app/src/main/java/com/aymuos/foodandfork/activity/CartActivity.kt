...
class CartActivity : AppCompatActivity() {
    ...
    val orderList=ArrayList<ResMenu>()
    ...
    private  fun cartList() {
        ...
        for(element in list){
            ...
            orderList.addAll(Gson().fromJson(element.foodItems,Array<ResMenu>::class.java).asList())
        }
        ...
        recyclerAdapter= CartAdapter(orderList,this@CartActivity)
        layoutManager = LinearLayoutManager(this@CartActivity)
